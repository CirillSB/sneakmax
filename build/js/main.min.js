...
var _testWebp = require("./utils/test-webp");
var _initModals = require("./modules/modals/init-modals");
var _form = require("./modules/form-validate/form");
var _rangeSlider = require("./modules/range-slider/range-slider");
var _initMap = require("./modules/map/init-map");
var _initDetails = require("./modules/details-accordeon/init-details");
var _pairSelection = require("./modules/pair-selection/pair-selection");
var _telMask = require("./modules/mask-tel/tel-mask");
var _initDynamicAdaptive = require("./modules/dynamic-adaptive/init-dynamic-adaptive");
// import {
//   setMaskTel
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _rangeSlider.setRangeSlider)();
    (0, _initDetails.initDetails)();
    (0, _pairSelection.choosePair)();
    // initPhoneMask();
    (0, _telMask.initTelMask)();
    (0, _initMap.initMap)();
...
},{"./modules/details-accordeon/init-details":2,"./modules/dynamic-adaptive/init-dynamic-adaptive":4,"./modules/form-validate/form":6,"./modules/map/init-map":12,"./modules/mask-tel/tel-mask":13,"./modules/modals/init-modals":15,"./modules/pair-selection/pair-selection":18,"./modules/range-slider/range-slider":19,"./utils/ios-vh-fix":21,"./utils/test-webp":22}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initDetails = void 0;
var initDetails = exports.initDetails = function initDetails() {
  var canvasItems = document.querySelectorAll('.questions__item');
  var details = document.querySelectorAll('.questions__details');
  var summarys = document.querySelectorAll('.questions__summary');
  var runDetails = function runDetails() {
...
var DynamicAdaptive = exports.DynamicAdaptive = /*#__PURE__*/function () {
  function DynamicAdaptive(type) {
    _classCallCheck(this, DynamicAdaptive);
    this.type = type;
    this._baseWindowWidth = '767';
  }
  return _createClass(DynamicAdaptive, [{
    key: "init",
    value: function init() {
      var _this = this;
      // массив объектов
...
var initDynamicAdaptive = exports.initDynamicAdaptive = function initDynamicAdaptive() {
  var dynamicAdaptive = new _dynamicAdaptive.DynamicAdaptive('max');
  dynamicAdaptive.init();
};

},{"./dynamic-adaptive":3}],5:[function(require,module,exports){
"use strict";
...
exports.initTelMask = void 0;
var initTelMask = exports.initTelMask = function initTelMask() {
  ...
  var onPhoneInput = function onPhoneInput() {
    var formattedInputValue = '';
    for (var i = 0; i < phoneInputs.length; i++) {
      if (event.target === phoneInputs[i]) {
        var inputNumbersValue = getInputNumbersValue(phoneInputs[i]);
        ...
        if (inputNumbersValue[0].includes('7') || inputNumbersValue[0].includes('8') || inputNumbersValue[0].includes('9')) {
          if (inputNumbersValue[0] == '9') {
            inputNumbersValue = "+7 ".concat(inputNumbersValue);
            phoneInputs[i].value = inputNumbersValue;
          }
          ;
          var firstSymbols = void 0;
          ...
          return phoneInputs[i].value = "+".concat(inputNumbersValue.substring(0, 17));
        }
      }
    }
  };
...
},{"./focus-lock":14,"./scroll-lock":17}],17:[function(require,module,exports){
"use strict";
...
exports.choosePair = void 0;
var choosePair = exports.choosePair = function choosePair() {
  var canvas = document.querySelector('.wrapper');
  var stepList = document.querySelectorAll('[data-step-list]');
  var step = document.querySelector('[data-step-number]');
  var slideButton = document.querySelector('[data-slide-button]');
  var submitButton = document.querySelector('[data-button-get]');
  var stepField = document.querySelector('[data-step-field]');
  var message = document.querySelectorAll('[data-message]');
  var form = document.querySelector('.selection-form');
  var removeCanvasEventListener = function removeCanvasEventListener() {
  ...
  var makeStep = function makeStep() {
    for (var _i = 0; _i < stepList.length - 1; _i++) {
      if (!stepList[_i].classList.contains('js-hidden')) {
        stepList[_i].classList.add('js-hidden');
        stepList[_i + 1].classList.remove('js-hidden');
        _i += 1;
        step.textContent = stepList[_i].dataset.dataStepList;
        if (stepList[_i].querySelector('input')) {
          stepList[_i].querySelector('input').focus();
        }
        if (stepList[_i].querySelector('textarea')) {
          stepList[_i].querySelector('textarea').focus();
        }
  ...
  var runClick = function runClick() {
    if (event.target === slideButton) {
      makeStep();
    }
  };
  var runPointerDown = function runPointerDown(e) {
...
exports.setRangeSlider = void 0;
var setRangeSlider = exports.setRangeSlider = function setRangeSlider() {
  var slider = document.querySelector('[data-range-slider]');
  var fields = document.querySelectorAll('[data-slider-field]');
  if (slider) {
  ...
  var getRangeSlider = function getRangeSlider(i, value) {
    var arr = [null, null];
    arr[i] = value;
...
var testWebP = exports.testWebP = function testWebP() {
