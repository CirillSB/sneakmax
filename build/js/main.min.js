...
var initPhoneMask = exports.initPhoneMask = function initPhoneMask() {
  ...
  var _loop = function _loop(i) {
    var initPlaceholder = function initPlaceholder() {
      var changePlaceholder = function changePlaceholder() {
        for (var _i = 0; _i < phoneInputs.length; _i++) {
          if (event.target === phoneInputs[_i]) {
            phoneInputs[_i].placeholder = '+7 (___) ___-____';
          }
        }
      };
      var returnPlaceholder = function returnPlaceholder() {
        for (var _i2 = 0; _i2 < phoneInputs.length; _i2++) {
          if (event.target === phoneInputs[_i2]) {
            phoneInputs[_i2].placeholder = 'Номер телефона';
          }
        }
      };
      console.log('obj');
    ...
    var getKeyValue = function getKeyValue(e) {
...
var choosePair = exports.choosePair = function choosePair() {
  ...
  var removeEventListenerSlideButton = function removeEventListenerSlideButton() {
