...
var _phoneMask = require("./modules/mask-tel/phone-mask");
...
},{"./modules/details-accordeon/init-details":2,"./modules/dynamic-adaptive/init-dynamic-adaptive":4,"./modules/form-validate/form":6,"./modules/map/init-map":12,"./modules/mask-tel/phone-mask":13,"./modules/modals/init-modals":15,"./modules/pair-selection/pair-selection":18,"./modules/range-slider/range-slider":19,"./utils/ios-vh-fix":21,"./utils/test-webp":22}],2:[function(require,module,exports){
"use strict";
...
var changePlaceholder = function changePlaceholder() {
...
var returnPlaceholder = function returnPlaceholder() {
  for (var i = 0; i < phoneInputs.length; i++) {
    if (event.target === phoneInputs[i]) {
